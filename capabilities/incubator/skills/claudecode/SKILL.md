---
name: Codex
description: This skill should be used when the user asks "how to use Codex", "Codex commands", "Codex features", "what can Codex do", "Codex tips", "Codex shortcuts", "how to configure Codex", or needs guidance on working effectively with Codex CLI.
version: 1.0.0
---

# Codex

Guide to working effectively with Codex CLI.
...
| `/init` | Initialize AGENTS.md in project |
...
Project instructions stored in `AGENTS.md`:
...
**Location Priority:**
1. `./AGENTS.md` - Current directory (highest)
2. `~/.Codex/AGENTS.md` - Global (lowest)
...
| Model | Best For |
|-------|----------|
| `Codex-sonnet` | Fast, everyday tasks (default) |
| `Codex-opus` | Complex reasoning, architecture |
| `Codex-haiku` | Quick answers, simple tasks |
...
Create in `.Codex/skills/` or `.windsurf/skills/`:
...
4. **Use context files** - Maintain AGENTS.md for projects
